...
const translations: Record<Lang, Record<string, string>> = {
  uz: {
    ...
    'checkout.success_desc_card': 'Xaridingiz uchun rahmat. To\'lovni amalga oshirgach, chek skrinshotini shu botga yuboring — buyurtmangizni tez orada jo\'natamiz.',
  ...
  ru: {
    ...
    'checkout.success_desc_card': 'Спасибо за покупку. После оплаты отправьте скриншот чека в этот бот — мы быстро отправим ваш заказ.',
  ...
  en: {
    ...
    'checkout.success_desc_card': 'Thank you for your purchase. After paying, please send a screenshot of your receipt to this bot — we will ship your order right away.',
